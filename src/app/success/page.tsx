...
function SuccessContent() {
  ...
  const handleCopyAll = async (as: "txt" | "json" = "txt") => {
    const text =
      as === "json"
        ? JSON.stringify(Object.fromEntries(nonEmpty.map((field) => [field.key, field.value])), null, 2)
        : formatFields();
          ...
          <div className="mx-auto max-w-2xl px-6">
            ...
            >
              ...
              <div className="space-y-4 p-6">
                ...
                {deviceData.imei && (
                  <DeviceInfoCard label="IMEI" value={deviceData.imei} type="imei" />
                )}

                {deviceData.meid && (
                  <DeviceInfoCard label="MEID" value={deviceData.meid} type="imei" />
                )}
              </div>
